namespace :products do
  ...
  task :create => :environment do 
    ...
    2.times do
      ...
      pro.avatar.attach(io: File.open("#{images}/image1.jpeg"), filename: 'image1.jpeg')
      pro = Product.create(name: "Product", price: 200, quantity: 6)
      pro.avatar.attach(io: File.open("#{images}/image2.jpeg"), filename: 'image1.jpeg')
      pro = Product.create(name: "Product", price: 300, quantity: 4)
      pro.avatar.attach(io: File.open("#{images}/image3.jpeg"), filename: 'image1.jpeg')
